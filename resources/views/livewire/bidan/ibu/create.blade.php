            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Masukan Alamat" wire:model="alamat">
                        @error('alamat') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput2">Nomor HP</label>
                        <input type="text" class="form-control" id="exampleFormControlInput3" wire:model="no_hp" placeholder="Masukan Nomor HP">
