                ...
                <div class="flex justify-around">
                    <div class="mt-4 flex flex-col items-center">
                        ...
                        <div class="text-sm {{ ($item->berat_badan < 15) ? 'text-red-500' : ($item->berat_badan >= 15 && $item->berat_badan <= 25 ? 'text-blue-500' : 'text-red-500')}}">
                            @if ($item->berat_badan < 15) Kekurangan @elseif ($item->berat_badan >= 15 && $item->berat_badan <= 25) Normal @else Kelebihan BB @endif </div> </div> <div class="mt-4 flex flex-col items-center">
                                    <div>icon tb</div>
                                    ...
                                    <div class="{{ ($item->tinggi_badan < 15) ? 'text-red-500' : ($item->tinggi_badan >= 15 && $item->tinggi_badan <= 25 ? 'text-blue-500' : 'text-red-500')}}">
                                        @if ($item->tinggi_badan < 18) Kurang Tinggi @elseif ($item->tinggi_badan >= 18 && $item->tinggi_badan <= 25) Ideal @else Terlalu tinggi @endif </div> </div> </div> <!-- container data -->
