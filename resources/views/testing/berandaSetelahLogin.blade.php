...
<body class="bg-blue-500 md:bg-white duration-300 overflow-x-hidden">
    ...
    <header class="flex justify-between items-center w-full mt-12 md:mt-32 mx-5 md:mx-16 mb-32 flex-wrap ">
        ...
        <div class="w-3/4 md:w-2/6">
            <h1 class="text-2xl text-white md:text-black md:text-4xl font-medium">
                Selamat Datang
                <br>
                ibu <span class="font-semibold">Riyanti</span>
            </h1>
    ...
    <section class="w-screen mt-20 pb-20  md:hidden bg-white rounded-tr-3xl rounded-tl-3xl">
        <div class="mx-8 pt-8">
            ...
            <div class="mt-8 mx-2">
                <div class="w-full bg-blue-100 my-4 py-4 px-3 border-l-8 border-blue-500 rounded-l-lg">
                    <h4 class="font-semibold text-lg mb-2">Rizal Elsa Fanny</h4>
                    <p class="text-gray-600">
                        bulan ini dalam keadaan <b>Sehat</b> dengan keterangan sebagai berikut : <br>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore autem quasi dolores obcaecati cum hic explicabo similique totam mollitia nesciunt officiis adipisci possimus, eos, quidem voluptatibus. Sint molestiae at veritatis?
                    </p>
                </div>

                <div class="w-full bg-red-100 my-4 py-4 px-3 border-l-8 border-red-500 rounded-l-lg">
                    <h4 class="font-semibold text-lg mb-2">Rizal Elsa Fanny</h4>
                    <p class="text-gray-600">
                        bulan ini dalam keadaan <b>Pertanda Stunting</b> dengan keterangan sebagai berikut : <br>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. At minima corporis ex veniam hic labore iste molestias numquam deleniti eum assumenda explicabo, architecto ipsum quas id voluptatem, enim, temporibus cumque.
                    </p>
                </div>
